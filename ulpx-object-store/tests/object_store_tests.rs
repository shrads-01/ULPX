...
fn get_temp_dir() -> PathBuf {
    ...
    let path = std::env::temp_dir().join(format!("ulpx_obj_store_test_{}_{}", std::process::id(), count));
...
fn test_parquet_integration() {
    ...
    use ulpx_replay::interpretation::{Interpretation, InterpretationId, PipelineConfiguration, ComponentConfig};
    ...
    let interp = Interpretation {
        ...
        pipeline_config: PipelineConfiguration {
            framer: ComponentConfig { id: "f".into(), version: "1".into() },
            mapper: ComponentConfig { id: "m".into(), version: "1".into() },
            parser_registry: vec![],
